...
/**
 * This class contains functions that perform the creation of Gradle [BuildReport]s for both [Assignment]s and [Submission]s.
 */
@Service
class BuildReportBuilderAndroid : BuildReportBuilder() {
     ...
     *
     * @param outputLines is a List of String with the output of a Gradle build process
    ...
    override fun build(outputLines: List<String>,
        ...
        LOG.info("Created build report for Android.")
        return BuildReportAndroid(outputLines, mavenizedProjectFolder, assignment, jUnitResults, jacocoResults,
