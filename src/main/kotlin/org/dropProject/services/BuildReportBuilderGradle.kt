 ...
 */
@Service
class BuildReportBuilderGradle : BuildReportBuilder() {
    ...
    override fun build(outputLines: List<String>,
        ...
        LOG.info("Created build report for Gradle.")
        return BuildReportGradle(outputLines, mavenizedProjectFolder, assignment, jUnitResults, jacocoResults,
